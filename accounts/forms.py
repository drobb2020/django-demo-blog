...
class UserProfileForm(forms.ModelForm):
    ...
    class Meta:
        model = Profile
        fields = ('bio', 'favorite_quote', 'avatar')
        
        widgets = {
            'bio': forms.Textarea(attrs={'class': 'form-control', 'rows': '5', 'placeholder': 'Your Bio'}),
            'favorite_quote': forms.Textarea(attrs={'class': 'form-control', 'rows': '5', 'placeholder': 'Your favorite quote'}),
        }
